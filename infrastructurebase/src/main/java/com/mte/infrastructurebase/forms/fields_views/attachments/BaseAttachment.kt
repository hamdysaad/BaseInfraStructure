...
//            fragment.activity!!.startActivityForResult(intent, PICK_FILE_RESULT_CODE)
            ...
            Timber.e("No activity can handle picking a file. Showing alternatives.")
        }
    }
    ...
    /*GET Attachmodels */
    private fun getAttachmentsFromIntent(intent: Intent?): List<AttachmentModel?> {

        val pathList = ArrayList<AttachmentModel?>()
